...
input
#> torch_tensor
#> -0.7489  1.5279 -0.1832
#>  0.0829  0.1543 -0.9297
#> [ CPUFloatType{2,3} ]
```
...
output
#> torch_tensor
#>  0.0918  0.0659 -1.4232  0.9575
#> -0.3890 -0.1299 -0.9283  0.4509
...
output
#> torch_tensor
#>  0.2802  0.3821  0.3377
#>  0.2972  0.3925  0.3102
...
small_module(input)
#> torch_tensor
#>  0.7976 -0.4026  0.0006 -1.0545
#>  1.0577 -0.0522 -0.3316 -0.7427
#> [ CPUFloatType{2,4} ][ grad_fn = <AddmmBackward0> ]
```
...
#> torch_tensor
#>  0.5249  0.4092  1.5326 -1.3239
#>  0.7290  0.2648  1.4484 -1.4773
#>  0.5398  0.3984  1.3856 -1.2463
...
graph_module(input)
#> torch_tensor
#>  0.4252  0.1313  0.4435
#>  0.4083  0.1547  0.4370
#> [ CPUFloatType{2,3} ][ grad_fn = <SoftmaxBackward0> ]
```
...
5.  The resulting module has multiple inputs and multiple outputs. We
    ...
    #> $nn_softmax.output
    #> torch_tensor
    #>  0.0796  0.1832  0.7372
    #>  0.0888  0.2010  0.7102
    #> [ CPUFloatType{2,3} ][ grad_fn = <SoftmaxBackward0> ]
    ```
    ...
    #> $output
    #> torch_tensor
    #>  4.4089  1.9173 -1.0764 -0.4002
    #>  4.0715  1.8357 -1.1049 -0.2400
    #> [ CPUFloatType{2,4} ][ grad_fn = <AddmmBackward0> ]
    iris_module$graph$pipeops$linear3$.result
    #> $output
    #> torch_tensor
    #>  0.5394  0.5952  0.0785 -0.1650 -0.4055
    #>  0.5394  0.5952  0.0785 -0.1650 -0.4055
    ...
    #> $output
    #> torch_tensor
    #>  4.4089  1.9173 -1.0764 -0.4002  0.5394  0.5952  0.0785 -0.1650 -0.4055
    #>  4.0715  1.8357 -1.1049 -0.2400  0.5394  0.5952  0.0785 -0.1650 -0.4055
